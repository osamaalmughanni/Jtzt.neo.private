      ...
      <FormPanel>
        ...
        <FormSection>
          <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-3 rounded-xl border border-border bg-card p-4">
                    ...
                    <div className="flex flex-col gap-3">
                      {field.options.map((option, optionIndex) => (
                        <div key={option.id} className="flex flex-col gap-3 rounded-xl border border-border bg-background p-3">
                          <FormFields>
            ...
            {settings.customFields.length === 0 ? <p className="text-sm text-muted-foreground">No fields yet.</p> : null}
          </div>
        </FormSection>
