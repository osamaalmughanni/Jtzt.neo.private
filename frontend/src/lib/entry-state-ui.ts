...
export function getEntryStateUi(t: TFunction): EntryStateUiMap {
  return {
    work: {
      ...
      tabActiveClassName: "border-emerald-500/30 bg-emerald-500/15 text-emerald-700 dark:border-emerald-400/30 dark:bg-emerald-400/15 dark:text-emerald-200",
      ...
      calendarCellClassName: "border-emerald-500/30 text-foreground dark:border-emerald-400/30",
      calendarInnerClassName: "bg-emerald-500/12 ring-1 ring-inset ring-emerald-500/20 dark:bg-emerald-400/12 dark:ring-emerald-400/20",
      recordStatusClassName: "border-emerald-500/20 bg-emerald-500/10 text-emerald-600 dark:text-emerald-400",
      barTrackClassName: "bg-emerald-500/10 dark:bg-emerald-400/10",
      barFillClassName: "bg-emerald-500 dark:bg-emerald-400",
      barOverflowClassName: "bg-rose-500 dark:bg-rose-400",
    },
    vacation: {
      ...
      tabActiveClassName: "border-sky-500/30 bg-sky-500/15 text-sky-700 dark:border-sky-400/30 dark:bg-sky-400/15 dark:text-sky-200",
      ...
      calendarCellClassName: "border-sky-500/30 text-foreground dark:border-sky-400/30",
      calendarInnerClassName: "bg-sky-500/12 ring-1 ring-inset ring-sky-500/20 dark:bg-sky-400/12 dark:ring-sky-400/20",
      recordStatusClassName: "border-sky-500/20 bg-sky-500/10 text-sky-600 dark:text-sky-400",
      barTrackClassName: "bg-sky-500/10 dark:bg-sky-400/10",
      barFillClassName: "bg-sky-500 dark:bg-sky-400",
      barOverflowClassName: "bg-rose-500 dark:bg-rose-400",
    },
    time_off_in_lieu: {
      ...
      tabActiveClassName: "border-yellow-500/30 bg-yellow-500/15 text-yellow-700 dark:border-yellow-400/30 dark:bg-yellow-400/15 dark:text-yellow-200",
      ...
      calendarCellClassName: "border-yellow-500/30 text-foreground dark:border-yellow-400/30",
      calendarInnerClassName: "bg-yellow-500/12 ring-1 ring-inset ring-yellow-500/20 dark:bg-yellow-400/12 dark:ring-yellow-400/20",
      recordStatusClassName: "border-yellow-500/20 bg-yellow-500/10 text-yellow-700 dark:text-yellow-300",
      barTrackClassName: "bg-yellow-500/10 dark:bg-yellow-400/10",
      barFillClassName: "bg-yellow-500 dark:bg-yellow-400",
      barOverflowClassName: "bg-rose-500 dark:bg-rose-400",
    },
    sick_leave: {
      ...
      tabActiveClassName: "border-rose-500/30 bg-rose-500/15 text-rose-700 dark:border-rose-400/30 dark:bg-rose-400/15 dark:text-rose-200",
      ...
      calendarCellClassName: "border-rose-500/30 text-foreground dark:border-rose-400/30",
      calendarInnerClassName: "bg-rose-500/12 ring-1 ring-inset ring-rose-500/20 dark:bg-rose-400/12 dark:ring-rose-400/20",
      recordStatusClassName: "border-rose-500/20 bg-rose-500/10 text-rose-600 dark:text-rose-400",
      barTrackClassName: "bg-rose-500/10 dark:bg-rose-400/10",
      barFillClassName: "bg-rose-500 dark:bg-rose-400",
      barOverflowClassName: "bg-rose-600 dark:bg-rose-300",
    },
    holiday: {
      ...
      calendarCellClassName: "border-border text-foreground",
      calendarInnerClassName: "bg-muted ring-1 ring-inset ring-border/70",
    ...
    mixed: {
      ...
      calendarCellClassName: "border-violet-500/30 text-foreground dark:border-violet-400/30",
      calendarInnerClassName: "bg-violet-500/12 ring-1 ring-inset ring-violet-500/20 dark:bg-violet-400/12 dark:ring-violet-400/20",
      recordStatusClassName: "",
      barTrackClassName: "bg-violet-500/10 dark:bg-violet-400/10",
      barFillClassName: "bg-violet-500 dark:bg-violet-400",
      barOverflowClassName: "bg-rose-500 dark:bg-rose-400",
    },
  };
}
