  ...
  en: {
    translation: {
      ...
      dashboard: {
        ...
        futureVacationOnly: "{{date}} is {{days}} day(s) ahead. Vacation remains available, but future work and sick leave are disabled.",
  ...
  de: {
    translation: {
      ...
      dashboard: {
        ...
        futureVacationOnly: "{{date}} liegt {{days}} Tage in der Zukunft. Urlaub bleibt möglich, aber zukünftige Arbeits- und Krankenstandseinträge sind deaktiviert.",
