  ...
  en: {
    translation: {
      ...
      adminCompanies: {
        ...
        companyReset: "Company database reset",
        companyResetFailed: "Reset failed",
        ...
        resetDialogTitle: "Reset company database",
        resetDialogDescription: "Reset \"{{name}}\" and remove all company data? This cannot be undone.",
  ...
  de: {
    translation: {
      ...
      adminCompanies: {
        ...
        companyReset: "Firmendatenbank zurückgesetzt",
        companyResetFailed: "Zurücksetzen fehlgeschlagen",
        ...
        resetDialogTitle: "Firmendatenbank zurücksetzen",
        resetDialogDescription: "\"{{name}}\" zurücksetzen und alle Firmendaten entfernen? Dies kann nicht rückgängig gemacht werden.",
